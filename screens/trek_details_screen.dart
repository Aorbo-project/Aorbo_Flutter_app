  ...
  LinearGradient getRatingColor(double rating) {
    if (rating >= 3.0 && rating <= 3.8) {
      return const LinearGradient(
        ...
        colors: [CommonColors.cFFFFFA5F, CommonColors.cFFFFFA5F],
      );
    } else if (rating < 3.0) {
      return const LinearGradient(
        begin: Alignment.topCenter,
        end: Alignment.bottomCenter,
        colors: [CommonColors.cancelledColor, CommonColors.cancelledColor],
      );
    }
    return const LinearGradient(
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
      colors: [CommonColors.cFF19FA00, CommonColors.cFF4EE53D],
    );
  }
  ...
  void _showImageViewer(
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        height: 100.h,
        decoration: BoxDecoration(color: CommonColors.transparent),
        child: Stack(
          children: [
            // PageView for images
            PageView.builder(
                    ...
                    child: InteractiveViewer(
                      ...
                      child: CachedNetworkImage(
                        ...
                        errorWidget: (context, url, error) => const Center(
                          child: Icon(Icons.broken_image, color: CommonColors.grey500),
                        ),
                      ),
                    ),
                  ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: text == _selectedSortOption
              ? CommonColors.materialBlue.withValues(alpha: 0.1)
              : CommonColors.whiteColor,
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: CommonColors.grey500.withValues(alpha: 0.2),
                          spreadRadius: 0,
                          blurRadius: 8,
                          offset: const Offset(0, 2),
                        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            // color: CommonColors.grey500.withValues(alpha: 0.1),
            color: CommonColors.blackColor.withValues(alpha: 0.1),
            spreadRadius: 0,
            blurRadius: 2.w,
            offset: Offset(0, 2),

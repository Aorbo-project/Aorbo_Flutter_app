...
class _BookingsCancelScreenState extends State<BookingsCancelScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (arguments is BookingHistoryData) {
      ...
      final candidate = arguments['booking'];
      if (candidate is BookingHistoryData) {
        booking = candidate;
      }
    }
    ...
    return Sizer(
      builder: (context, orientation, deviceType) {
        return Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: CommonColors.materialLightBlue.withValues(
              alpha: 0.2,
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  height: 20.w,
                  decoration: BoxDecoration(
                    color: CommonColors.materialRed.withValues(alpha: 0.1),

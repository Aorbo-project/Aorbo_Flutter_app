            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Icon(Icons.keyboard_arrow_down,
                                              color: CommonColors.blackColor, size: 6.w),
                                        ],
                                      ),
                                    ),
                                  ),
                      ...
                      child: InkWell(
                        onTap: () async {
                          ...
                          if (isTravellerUpdate) {
                            ...
                            appLog('message : ${_userC.nameControllerTraveller.value.text},${_userC.ageControllerTraveller.value} ');
                            setState(() {
                              isShowTravellerForm = false;
                            });
                          }
                  ...
                  //           // Added decoration
                  //           border: Border.all(
                  //               color: CommonColors.greyColor878787), // Added border
                  //           borderRadius:
                  //               BorderRadius.circular(8), // Added border radius
                  //           color: CommonColors.whiteColor, // Added background color
                  //         ),
                  //         child: Material(
                  ...
                  //       foregroundColor: CommonColors.transparent,
                  //       disabledForegroundColor: CommonColors.transparent,
                  //     ),
                  //     child: Text(
                  //       'Save Changes',
                  //       style: GoogleFonts.poppins(

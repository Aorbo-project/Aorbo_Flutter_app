...
class _C {
  ...
  static const tealLight = CommonColors.cFF1AA090;
  static const tealSoft  = CommonColors.cFFE6F5F3;
  static const ink       = CommonColors.cFF121212;
  static const inkMid    = CommonColors.cFF444444;
  static const inkLight  = CommonColors.cFF888888;
  static const divider   = CommonColors.trekroutecolorlight;
  static const cardBg    = CommonColors.cFFF9F9F7;
  static const white     = CommonColors.whiteColor;
  static const footerText= CommonColors.cFFD8D8D8;
  static const red       = CommonColors.cFFB52424;
}
          ...
          const DecoratedBox(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  CommonColors.c1A000000,
                  CommonColors.transferent,
                  CommonColors.c4D000000,
                  CommonColors.cB8000000,
                ],
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        height: 38,
        decoration: BoxDecoration(
          color: filled ? _C.cardBg :   CommonColors.c40000000,
          shape: BoxShape.circle,
          border: Border.all(
            color: filled ? _C.divider :   CommonColors.c4DFFFFFF,
            width: 1,
          ),
        ),
        child: Icon(

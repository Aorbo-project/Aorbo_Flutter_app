                            ...
                            child: Listener(
                              ...
                              child: PageView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  final discount = discountCards[
                                      index % discountCards.length];
                                  return Container(
                                    ...
                                    child: CommonDiscountCard(
                                      ...
                                      code: discount.code,
                                      offerAmount: discount.offerAmount,
                                      imagePath: discount.imagePath,
                                      imageHeight: discount.imageHeight,
                                      detailedDescription:
                                          discount.detailedDescription,
                                      howToApply: discount.howToApply,
                                      termsAndConditions:
                                          discount.termsAndConditions,
                                      footerNote: discount.footerNote,
                                    ),
                                  );
                                },
                              ),

    ...
    return Sizer(
      builder: (context, orientation, deviceType) {
        return Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: CommonColors.materialLightBlue.withValues(alpha: 0.2),
          ...
          body: Stack(
            children: [
              ...
              Container(
                height: 8.h,
                color: CommonColors.materialLightBlue.withValues(alpha: 0.2),
              ),
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            padding: EdgeInsets.all(4.w),
            decoration: BoxDecoration(
              color: CommonColors.cFFE8F4F8, // Light blue background
              borderRadius: BorderRadius.only(
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  height: 12.w,
                  decoration: BoxDecoration(
                    color: CommonColors.materialOrange,
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Container(
                              ...
                              height: 3.w,
                              decoration: BoxDecoration(
                                color: CommonColors.materialPink,

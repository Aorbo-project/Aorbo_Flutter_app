...
class _DashboardState extends State<Dashboard>
  ...
  int selectedIndex = 0;
  DateTime? _ntpTime;
  DateTime? _ntpFetchedAt;
  bool _ntpFetchInProgress = false;
  ...
  Future<void> _initializeNTPTime() async {
    if (_ntpFetchInProgress) return;
    if (_ntpFetchedAt != null) {
      final age = DateTime.now().difference(_ntpFetchedAt!);
      if (age < const Duration(minutes: 10)) return;
    }

    _ntpFetchInProgress = true;
    try {
      final ntpTime = await NTP.now();
      if (!mounted) return;
      setState(() {
        _ntpTime = ntpTime;
        _ntpFetchedAt = DateTime.now();
      });
    } catch (e) {
  ...
  void _handleSearchPress() async {
    ...
    appLog('date: ${_dashboardC.dateController.value.text}');
            ...
            Card(
              ...
              child: Container(
                ...
                child: SafeArea(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: AppDimensions.dw(16)),
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: AppDimensions.dh(27)),
                        // Search Card
                        Container(
                          // height: 24.h,
                          // color: CommonColors.materialRed,
                          ...
                          child: Card(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius:
                                  BorderRadius.circular(AppDimensions.ds(20)),
                            ),
                            elevation: 3,
                            child: Padding(
                              padding: EdgeInsets.only(
                                  left: AppDimensions.dw(25),
                                  right: AppDimensions.dw(25),
                                  top: AppDimensions.dh(20),
                                  bottom: AppDimensions.dh(16)),
                              child: Column(
                                children: [
                                  // From Field
                                  Stack(
                                          ...
                                          GestureDetector(
                                            ...
                                            child: Padding(
                                              ...
                                              child: SvgPicture.asset(
                                                ...
                                                height: AppDimensions.ds(24),
                                                width: AppDimensions.ds(24),
                                              ),
                                            ),
                                          ),
                                          SizedBox(
                                              width: AppDimensions.dw(12)),
                                          Expanded(
                                            child: Stack(
                        ...
                        Container(
                          ...
                          child: Card(
                            ...
                            shape: RoundedRectangleBorder(
                              borderRadius:
                                  BorderRadius.circular(AppDimensions.ds(12)),
                            ),
                            child: Padding(
                              padding: EdgeInsets.all(AppDimensions.ds(15)),
                              child: Row(
                                children: [
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          SizedBox(
                                              height: AppDimensions.dh(4)),
                                          SvgPicture.asset(
                                            CommonImages.weekend,
                                            height: AppDimensions.ds(25),
                                            width: AppDimensions.ds(25),
                                            colorFilter: ColorFilter.mode(
                                              _isFormValid
                                                  ? CommonColors.blackColor
                                                  : CommonColors.greyColor2,
                        ...
                        SizedBox(height: AppDimensions.dh(30)),
                      ],
                    ),
                  ),
                ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                        left: AppDimensions.dw(17),
                        right: AppDimensions.dw(17),
                        top: AppDimensions.dh(10)),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Column(
                        ...
                        children: [
                          ...topTreksCardsData
                              .map((trekData) => Container(
                                    margin: EdgeInsets.only(
                                      right: AppDimensions.dw(15),
                                    ),
                                    child: TopTreksCard(
                                      gradientEndColor: CommonColors.transparent,
                  ...
                  Padding(
                    padding: EdgeInsets.only(
                      left: AppDimensions.dw(16),
                      right: AppDimensions.dw(16),
                      top: AppDimensions.dh(10),
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  SingleChildScrollView(
                    ...
                    child: Container(
                      margin: EdgeInsets.only(
                        left: AppDimensions.dw(15),
                        top: 1.h,
                        bottom: AppDimensions.dh(15),
                      ),
                      child: Row(
                        children: [

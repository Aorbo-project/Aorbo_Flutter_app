...
class _KnowMoreScreenState extends State<KnowMoreScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
         List<KnowMoreData>? knowMoreCardsData = dashboardC.whatsNewObserver.value.maybeWhen(
           success: (whatsNewResponse) => (whatsNewResponse as WhatsNewDataResponseModel).data,
           error: (sc) => [],
           orElse: () => [KnowMoreData(),KnowMoreData(),KnowMoreData(),KnowMoreData()]);

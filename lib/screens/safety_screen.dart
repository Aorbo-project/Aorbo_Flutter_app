  ...
  final List<Map<String, dynamic>> safetyCards = [
    {
      ...
      'gradientColors': [
        CommonColors.purpleColor.withValues(alpha: 0.6),
        CommonColors.pinkColor.withValues(alpha: 0.6),
      ],
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                    ...
                    children: [
                      Text(
                        ...
                        style: GoogleFonts.poppins(
                          ...
                          fontWeight: FontWeight.w500,
                          color: CommonColors.blackColor.withOpacity(0.8),
                        ),
                      ),
                      Align(
                ...
                //         decoration: BoxDecoration(
                //           borderRadius: BorderRadius.circular(30),
                //           color: CommonColors.yellowColor2,
                //         ),
                //       ),
                //     ],
                //   ),

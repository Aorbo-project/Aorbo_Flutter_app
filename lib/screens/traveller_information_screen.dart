...
class _TravellerInformationScreenState
  ...
  void initState() {
    ...
    _trekControllerC.calculateFareRequestModel.value =
        _trekControllerC.calculateFareRequestModel.value.copyWith(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                                  ...
                                  children: [
                                    _counterBtn(Icons.remove, () {
                                      setState(() {
                                        if (adultCount > 1) {
                                          _trekControllerC.calculateFareRequestModel.value =
                                              _trekControllerC.calculateFareRequestModel.value.copyWith(travelerCount: adultCount - 1);
                                          if (selectedTravellers.length > adultCount) {
                                            selectedTravellers = selectedTravellers.take(adultCount).toList();
                                          }
                                        }
                                      });
                                      _trekControllerC.trekPersonCount.value = adultCount;
                                      _trekControllerC.travellerDetailList.value = selectedTravellers;
                                    }, active: adultCount > 1),
                                    Padding(
                  ...
                  Obx(() {
                    CalculateFareResponseModel? fareResp = _trekControllerC.calculateFareResponseModel.value.maybeWhen(
                          ...
                          children: [
                            ...
                            Obx(() {
                              ...
                              return GestureDetector(
                                onTap: () {
                                  _trekControllerC.calculateFareRequestModel.value =
                                      _trekControllerC.calculateFareRequestModel.value.copyWith(addFreeCancellationProtection: !freeCancellation);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _insuranceOption(
                            ...
                            onTap: () => _trekControllerC.calculateFareRequestModel.value =
                                _trekControllerC.calculateFareRequestModel.value.copyWith(addInsurance: true),
                          ),
                          ...
                          _insuranceOption(
                            ...
                            onTap: () => _trekControllerC.calculateFareRequestModel.value =
                                _trekControllerC.calculateFareRequestModel.value.copyWith(addInsurance: false),
                          ),
                        ],
                      ),
                    );
                      ...
                      children: [
                        ...
                        if (travelData.cancellationPolicy?.id != 1) ...[
                          _paymentOption(
                            ...
                            onTap: () {
                              ...
                              _trekControllerC.calculateFareRequestModel.value =
                                  _trekControllerC.calculateFareRequestModel.value.copyWith(cancellationPolicyType: 'flexible');
                            },
                          ),
                          SizedBox(height: 1.2.h),
                        ],
                        _paymentOption(
                          ...
                          onTap: () {
                            ...
                            _trekControllerC.calculateFareRequestModel.value =
                                _trekControllerC.calculateFareRequestModel.value.copyWith(cancellationPolicyType: 'standard');
                          },
                        ),
                      ],
                    ),
  ...
  Widget _buildBottomBar() {
    return Container(
      ...
      child: Obx(() {
        final fareReqModel = _trekControllerC.calculateFareRequestModel.value;
        CalculateFareResponseModel? fareRespModel = _trekControllerC.calculateFareResponseModel.value.maybeWhen(
          success: (r) => r, orElse: () => null);
        return Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            Padding(
              ...
              child: Obx(() {
                ...
                return CommonButton(
                  ...
                  onPressed: () {
                    if (isFormValid) {
                      _trekControllerC.createOrderRequestModel.value =
                          _trekControllerC.createOrderRequestModel.value.copyWith(travelers: selectedTravellers.toList());
    ...
    return Obx(() {
      ...
      if (selectedTravellers.length > adultCount) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (mounted) setState(() { selectedTravellers.clear(); _trekControllerC.travellerDetailList.value = []; });
        });

...
class _PaymentScreenState extends State<PaymentScreen>
  ...
  void _handleExternalWallet(ExternalWalletResponse r) {
    CustomSnackBar.show(context,
        message: 'Paying via ${r.walletName}. May take some time to reflect.');
  }

  bool get _isPaymentValid {
    final valid = _trekC.calculateFareResponseModel.value
    ...
    return Scaffold(
      ...
      body: FadeTransition(
        ...
        child: Obx(() {
          ...
          final breakdown = _trekC.calculateFareResponseModel.value
              .maybeWhen(
            ...
            children: [
              SingleChildScrollView(
                ...
                padding: EdgeInsets.only(
                    left: 4.w, right: 4.w, top: 2.h, bottom: 16.h),
                child: Column(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            CircularProgressIndicator(color: _Pay.accent,
                                strokeWidth: 2.5),
  ...
  Widget _buildTimer() {
    return Obx(() {
      final mins = _remainingSecs.value ~/ 60;
      final secs = _remainingSecs.value % 60;
      final label =
          '${mins.toString().padLeft(2, '0')}:${secs.toString().padLeft(2, '0')}';
      final progress = _remainingSecs.value / _totalTimerSecs;
      final isLow = _remainingSecs.value < 60;
          ...
          Row(
            ...
            children: [
              Icon(Icons.timer_outlined,
                  size: 13,
                  color: isLow ? _Pay.red : _Pay.orange),
  ...
  // ── Trek summary card ─────────────────────────────────────────────────────
  Widget _buildTrekSummaryCard(dynamic trek, dynamic fareReq,
  ...
  // ── Traveller details card (inline — no bottom sheet) ─────────────────────
  Widget _buildTravellerDetailsCard() {
    ...
    return _card(
      child: Column(
        ...
        children: [
          _sectionHeader(
              icon: Icons.people_outline_rounded, label: 'Traveller Details'),
          const SizedBox(height: 14),
  ...
  Widget _buildFareBreakdownCard(
      BreakDownDataModel? bd, dynamic fareReq) {
    return _card(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  // ── Coupon card ───────────────────────────────────────────────────────────
  Widget _buildCouponCard(dynamic fareReq,
      CalculateFareResponseModel? fareResponse) {
    final appliedCode = fareReq.couponCode ?? '';
    final isCouponApplied = fareResponse?.couponDetails != null;
              ...
              Container(
                ...
                child: Center(
                  child: SvgPicture.asset(
                    ...
                    height: 16,
                    colorFilter:
                        ColorFilter.mode(_Pay.accent, BlendMode.srcIn),
                  ),
                ),
              ),
            ...
            firstChild: Column(
              ...
              children: [
                ...
                if (appliedCode.isNotEmpty)
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          size: 18,
                          color:
                              isCouponApplied ? _Pay.green : _Pay.red,
                        ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              if (isCouponApplied)
                                Text(
                                  'You save ₹${fareResponse?.couponDetails?.discountAmount ?? '--'}',
                                  textScaler: const TextScaler.linear(1.0),
                                  style: TextStyle(
                                    fontFamily: 'Poppins',
                                    fontSize: FontSize.s9,
                  ...
                  // Empty state — browse coupons CTA
                  GestureDetector(
  ...
  Widget _buildPaymentMethodCard() {
    return _card(
      child: Column(
        ...
        children: [
          _sectionHeader(
              icon: Icons.payment_rounded, label: 'Payment Method'),
          const SizedBox(height: 14),
          ...
          _paymentOption(
            ...
            onTap: () => setState(
                () => _selectedUPI = PaymentMethods.razorpay),
          ),
  ...
  Widget _buildBottomBar() {
    return Container(
      ...
      child: Obx(() {
        ...
        final amount = bd?.amountToPayNow;

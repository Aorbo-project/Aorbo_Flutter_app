...
class ChatController extends GetxController {
  ...
  Future<void> initializeChat() async {
    try {
      ...
      isLoading.value = false;
      appLog('Error initializing chat: $e');
      CustomSnackBar.showGlobalError(message: 'Failed to initialize chat. Please try again.',
      );
      rethrow;
    }
  }
  ...
  void _setupSocketListeners() {
    ...
    _socketService.addListener('connected', (_) {
      ...
      appLog('✅ Chat connected');
    });

    _socketService.addListener('disconnected', (_) {
      isConnected.value = false;
      appLog('❌ Chat disconnected');
    });
  ...
  Future<void> fetchMessages({int page = 1, int limit = 50}) async {
    ...
    try {
      ...
      CustomSnackBar.showGlobalError(message: 'Failed to load messages',
      );
    }
  }
  ...
  Future<void> sendMessage() async {
    ...
    try {
      ...
      CustomSnackBar.showGlobalError(message: 'Failed to send message',
      );
    }
  }

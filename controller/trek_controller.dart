...
class TrekController extends GetxController {
    ...
    try {
      ...
      if (response != null) {
        if (response['success']) {
          ...
          CustomSnackBar.showGlobalSuccess(message: 'Payment Successful!');
        } else {
          hideLoaderDialog();
    ...
    try {
      ...
      if (response != null) {
        if (response['success']) {
          ...
          Get.back();
          Get.back();
          CustomSnackBar.showGlobalSuccess(
    ...
    try {
      ...
      if (response != null) {
        if (response['success'] == true) {
          ...
          CustomSnackBar.showGlobalError(message: couponErrorMessage.value);
        }
      }
    } catch (e) {
  ...
  void removeCoupon() {
    ...
    CustomSnackBar.showGlobalSuccess(message: 'Coupon removed successfully');
  }

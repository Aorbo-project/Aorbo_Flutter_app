...
class AuthController extends GetxController {
  ...
  Future<bool> verifyFirebaseToken(String firebaseToken) async {
    ...
    try {
      ...
      if (res != null && res['success'] == true) {
        try {
          ...
          if (token == null || token.isEmpty) {
            CustomSnackBar.showGlobalError(message: "Invalid token received");
            return false;
          }
          ...
          CustomSnackBar.showGlobalError(message: "Error processing server response");
          return false;
        }
      } else {
        CustomSnackBar.showGlobalError(message: res != null && res['message'] != null
                ? res['message']
      ...
      CustomSnackBar.showGlobalError(message: "Network error: ${e.toString()}");
      return false;
    } finally {
      isLoading.value = false;
    }

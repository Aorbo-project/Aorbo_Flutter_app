    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(
          side: BorderSide(color: CommonColors.grey500),
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Divider(height: 1, color: CommonColors.grey500),
                // Main Content
                Expanded(
                  child: Row(
                    children: [
                          ...
                          children: filterCategories.map((category) {
                            ...
                            return GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isSelected
                                      ? CommonColors.appBgColor.withValues(alpha: 0.1)
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: CommonColors.whiteColor,
                    border: Border(
                      top: BorderSide(color: CommonColors.grey500!),
                    ),
                  ),
                  child: Row(
                    children: [
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(color: CommonColors.grey500),
                          borderRadius: BorderRadius.circular(2.w),
                        ),
                        child: Row(
                          children: [
